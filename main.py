...
def run_pipeline():
    ...
    print("📊 請檢查資料夾內生成的圖表 (baseline_vs_spy_performance.png, ml_vs_baseline_performance.png, diagnostics_report.png, momentum_robustness.png, pooled_report.png) 與 模型權重檔 (saved_models/<fold>/*.pth)。")
    print("=" * 60)
